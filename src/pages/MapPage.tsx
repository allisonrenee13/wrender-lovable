...
import { traceOutlineImage } from "@/lib/traceOutlineImage";
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col items-center justify-center bg-muted/20 overflow-auto relative">
          ...
          {viewMode === "saved" && savedSVG && (
            <div className="flex-1 flex flex-col items-center p-2 md:p-4 w-full overflow-hidden">
              ...
              >
                <div
                  ...
                  className="[&>svg]:max-h-[calc(100vh-140px)] [&>svg]:w-full"
                  style={{
                    display: "block",
                    width: "100%",
                  }}
